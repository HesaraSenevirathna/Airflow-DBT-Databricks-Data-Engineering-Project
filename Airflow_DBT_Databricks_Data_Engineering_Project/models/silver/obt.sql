{% set configs = [
    {
        "table": "ghost.bronze.bronze_orders",
        "columns": """o.order_id,
                        o.store_id,
                        o.order_timestamp,
                        o.payment_method,
    ...
    {
        "table": "ghost.bronze.bronze_customers",
    ...
    {
        "table": "ghost.bronze.bronze_order_items",
    ...
    {
        "table": "ghost.bronze.bronze_products",
    ...
    {
        "table": "ghost.bronze.bronze_employees",
    ...
    {
        "table": "ghost.bronze.bronze_stores",
